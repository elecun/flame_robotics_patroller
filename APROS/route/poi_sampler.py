...
Usage:
  python3 poi_sampler.py <route_file> <poi_file> --min 1800 --max 8000 -n 10
  python3 poi_sampler.py -r <route_file> -p <poi_file> --min 1800 --max 8000 -n 10
"""
...
def main():
    ...
    parser.add_argument(
        ...
        type=float,
        default=1800.0,
        help="Minimum mast_height value (default: 1800.0)",
    )
    parser.add_argument(
        "--max",
        "--max-height",
        ...
        type=float,
        default=8000.0,
        help="Maximum mast_height value (default: 8000.0)",
    )
    parser.add_argument(
        "-n",
        "--num-samples",
